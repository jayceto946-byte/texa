...
def _register_builtins() -> None:
    ...
    for spec in (
        ...
        ModelSpec("qwen", "qwen-plus", "Qwen Plus", common | {Capability.REASONING}),
        ModelSpec("qwen", "qwen-vl-plus", "Qwen VL Plus", common | {Capability.REASONING, Capability.VISION}),
        ModelSpec("gemini", "gemini-2.5-pro", "Gemini 2.5 Pro", common | {Capability.REASONING, Capability.VISION}),
        ModelSpec("openai", "gpt-4o-mini", "GPT-4o mini", common | {Capability.REASONING, Capability.VISION}),
